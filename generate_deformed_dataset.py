...
print("Loading dataset...")
dset = MultimodalDataset(modA_out_path + '*', modB_out_path + '*', logA=modelA.log_transform, logB=modelB.log_transform, transform=None)

create_comirs(dset, batch_size, modelA, modelB)
