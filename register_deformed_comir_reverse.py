...
if __name__ == "__main__":
    ...
    #MSE_diff_comir_inspire = evaluate_MSE(modA_path_original, out_path)
    #MSE_diff_inspire = evaluate_MSE(modA_path_original, out_path_mono)
    #MSE_diff_elastix = evaluate_MSE(modA_path_original, elastix_out_dir)
    #MSE_diff_noreg = evaluate_MSE(modA_path_original, modA_path)
    #print("comir inspire", MSE_diff_comir_inspire)
    #print("inspire mono", MSE_diff_inspire)
    #print("elastix", MSE_diff_elastix)
    #print("no reg", MSE_diff_noreg)
